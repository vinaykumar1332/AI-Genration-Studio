    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{ background: '#A78BFA', top: '10%', right: '10%' }}
          animate={{
            scale: [1, 1.3, 1],
            x: [0, -40, 0],
            y: [0, 40, 0],
          }}
          transition={{ duration: 9, repeat, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute w-96 h-96 rounded-full blur-3xl opacity-30"
          style={{ background: '#2D5BFF', bottom: '10%', left: '10%' }}
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 40, 0],
            y: [0, -40, 0],
          }}
          transition={{ duration: 11, repeat, ease: 'easeInOut' }}
        />
      </div>
      ...
      <GlassCard className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p style={{ color: '#A47864' }}>
            Start your journey with European luxury AI
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              required
            />
            <label htmlFor="terms" className="text-sm" style={{ color: '#A47864' }}>
              I agree to the{' '}
          ...
          {/* Signup Button with Liquid Fill Animation */}
          <motion.button
            type="submit"
