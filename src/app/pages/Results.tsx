      ...
      <div className="pt-24 pb-16 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { label: 'Total Generated', value: generatedImages.length, icon: Sparkles, color: '#2D5BFF' },
              { label: 'This Week', value: generatedImages.length, icon: Sparkles, color: '#A78BFA' },
              { label: 'Resolution', value: '4K UHD', icon: Sparkles, color: '#A47864' },
            ].map((stat, index) => (
              <motion.div
                key={index}
